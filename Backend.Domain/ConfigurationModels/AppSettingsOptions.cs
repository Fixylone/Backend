namespace Backend.Domain.ConfigurationModels
{
    /// <summary>
    ...
    {
        private const string APP_SETTINGS_CONFIGURATION = "AppSettings";

        public static string AppSettingsConfigurationSectionName => APP_SETTINGS_CONFIGURATION;
